...
<IFRAME name=main   src=http://www.thaigqsoft.info/show_new.php?domain_name=huzzun  width=587 height=428 frameborder=0 scrolling=yes></IFRAME>
	...
	<tr>
		...
		<td colspan="5">
		<a href="http://www.thaigqsoft.info/card_true_acctive.php?domain_name=huzzun" target="_blank">
	...
	<tr>
		...
		<td colspan="3">
			<a href="http://www.thaigqsoft.info/forget_pass.php?domain_name=huzzun" target="_blank">
...
<a style="color: #0000FF;background-color: #FFFFFF" href="$(link-login-only)?dst=$(link-orig-esc)&username=T-$(mac-esc)">คลิกที่นี่เพื่อทดลองเล่น  15  นาที</a>$(endif)
							...
							<table width="183" style="background-color: #ffffff">
								...
								<tr><td>	<input type="hidden" name="dst" value="http://www.google.co.th" />

...
$g = new graph();
$g->title( " ALL User    Downloads Bar Chart   of  MONTH $todays2   For $todays3   ", '{font-size:20px; color: #FFFFFF; margin: 5px; background-color: #505050; padding:5px; padding-left: 20px; padding-right: 20px;}' );
 
$g->data_sets[] = $bar_red;
//$g->line_dot( 3, 5, '#ADB5C7', 'Line', 10 );    // <-- 3px thick + dots กราฟเส้น
$g->set_x_axis_3d( 20 );

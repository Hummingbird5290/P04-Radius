...
<body>
<form name="form1" method="post" action="index.php?case_i=82">
  <?
		...
		$sql = "SELECT *  FROM   card    where   active='1'     and domain='$domian_name'  and identity='$identity'  and  time_active BETWEEN '$date_view1' AND '$date_view2'";
		...
		$Show = $sql." ORDER BY    time_active desc  LIMIT $offset, $limit";
...
print  "&nbsp;&nbsp;$date_view1  -  $date_view2";
    ...
    <tr bgcolor="#FFFFCC"> 
      ...
      <th width="17%" align="center" bgcolor="#FFFFCC" class="scimenu"> <div align="center">card number </div></th>
      <th width="9%" align="center" bgcolor="#FFFFCC" class="scimenu"> <div align="center">user active </div></th>
      <th width="12%" align="center" class="scimenu"> <div align="center">Time active  </div></th>
      <th width="12%" align="center" class="scimenu"> <div align="center">จำนวนวัน</div></th>
      <th width="9%" align="center" class="scimenu"> <div align="center">กลุ่มความเร็ว</div></th>
      <th width="9%" align="center" class="scimenu">ราคา</th>
    </tr>
    <?
  if($rows<>0){
	  $i=1;
 ...
 <td height="21" class="ข้อความในตาราง" > <div align="center"> <? print $result_data[time_active];?></div></td>
 <td height="21" class="ข้อความในตาราง" > <div align="center"> <? print $result_data[date_end];?></div></td>
 <td height="21" class="ข้อความในตาราง" > <div align="center"> <? print $result_data[GroupName];?></div></td>
...
echo   "<a href='index.php?case_i=82&offset=$prevoffset&identity=$identity&date_view1=$date_view1&date_view2=$date_view2'>
<font  color=\"red\"><< ก่อนหน้า</font></a>\n\n";
    ...
    for ($i=1;$i<=$pages;$i++) { 
        ...
        if (($offset/$limit) == ($i-1)) { 
            ...
            $newoffset=$limit * ($i-1); 
                  echo  "<a href='index.php?case_i=82&offset=$newoffset&identity=$identity&date_view1=$date_view1&date_view2=$date_view2'     >

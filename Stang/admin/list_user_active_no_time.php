...
?>
  <table width="85%" border="0" align="center" cellpadding="1" cellspacing="1"  class="imagetable">
    <tr bgcolor="#FFFFFF"> 
      <th height="30" colspan="9"> <div align="right"><strong>ค้นหารหัสบัตร</strong> 
          <input name="txt_search" type="text" value="<?=$txt_search;?>" size="40">
          <input type="submit" name="Submit" value="  ค้นหา  " class="styled-button-2"  >
        </div></th>
    </tr>
    <tr bgcolor="#CCFFCC"> 
      <th colspan="9"> <div align="center" class="style1 style2"><font size="3" face="MS Sans Serif, Tahoma, sans-serif"><strong> รายการบัตรที่ทำการ Active</strong></font></div></th>
    </tr>
    <tr bgcolor="#FFFFCC"> 
      <th width="6%"> <div align="center" class="style3"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ลำดับ</font></strong></div></th>
      <th width="17%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">หมายเลขบัตร</font></strong></th>
      <th width="14%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ชื่อ Login</font></strong></th>
      <th width="8%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วันหมดอายุปัจจุบัน</font></strong></th>
      <th width="8%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">จำนวน</font></strong></th>
      <th width="24%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วันที่ Active </font></strong></th>
      <th width="13%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">Domain</font></strong></th>
      <th width="18%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ปรับเวลา</font></strong></th>

...
<IFRAME name="main"   src="http://www.thaigqsoft.info/show_new.php?domain_name=RTX " width="580" height="418" frameborder="0" scrolling="yes"></IFRAME>
	...
	<tr>
		...
		<td colspan="4">
			<a href="http://www.thaigqsoft.info/register1.php?domain_name=RTX" target="_blank">
	...
	<tr>
		...
		<td colspan="4">
		<a href="http://www.thaigqsoft.info/active.php?domain=RTX" target="_blank">
	...
	<tr>
		...
		<td colspan="5">
		<a href="http://www.thaigqsoft.info/card_true_acctive.php?domain_name=RTX" target="_blank">
	...
	<tr>
		...
		<td colspan="3">
		<a href="http://www.thaigqsoft.info/problem.php?domain_name=RTX" target="_blank">
	...
	<tr>
		...
		<td colspan="3">
			<a href="http://www.thaigqsoft.info/forget_pass.php?domain_name=RTX" target="_blank">
							...
							<table width="183" style="background-color: #ffffff">
								...
								<tr>
								  <td colspan="2" align="right"><div align="center"> <span class="style1">ทดลองเล่นฟรี ,</span>
								    <a  href="<?php echo $linkloginonly; ?>?dst=<?php echo $linkorigesc; ?>&username=T-<?php echo $macesc; ?>">คลิกที่นี่</a>.<br> 
							      </div></td>
							  </tr>

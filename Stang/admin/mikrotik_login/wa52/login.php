...
<body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
          <a class="brand" href="http://www.thaigqsoft.info/register1.php?domain_name=wa52">  Hotspot ระบบยืนยันตัวตนอินเตอร์เน็ตไร้สาย</a>
	...
	//-->
              ...
              <li class="active"><a href="http://www.thaigqsoft.info/register1.php?domain_name=wa52" target="_blank">ลงชื่อเพื่อใช้งานอินเตอร์เน็ต</a><br>
			   <li class="active"><a href="http://www.thaigqsoft.info/active.php?domain=wa52" target="_blank">เติมเวลาเล่นโดยใช้บัตรคูปอง</a><br>
			   <li class="active"><a href="http://www.thaigqsoft.info/card_true_acctive.php?domain_name=wa52" target="_blank">เติมเวลาเล่นโดยใช้บัตรทรูมันนี่</a><br>
			   <li class="active"><a href="http://www.thaigqsoft.info/problem.php?domain_name=wa52" target="_blank">แจ้งปัญหาการใช้งาน</a><br>
...
?>
  ...
  <a class="carousel-control right" href="#myCarousel" data-slide="next">&rsaquo;</a></div>
      ...
      <hr>
      <div align="center"><span class="alert-info style4"><strong>เชื่อมต่อทุกจิตนาการ        </strong></span></div>
          </div>
          <!--/row-->
      <hr>
      <footer>

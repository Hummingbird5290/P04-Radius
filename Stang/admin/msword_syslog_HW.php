...
<center>
  ...
  <table width="2048" border="1" align="left" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC">
    ...
    <tr bgcolor="#AFFFFF"> 
      ...
      <td width="7%" align="center" bgcolor="AFFFFF"><div align="center"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>Server</strong></font></div></td>
      <td width="11%" align="center" bgcolor="AFFFFF"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><span class="style3">Program 
        </span></font></strong></td>
      <td width="6%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">เวลา</font></strong></td>
      <td width="70%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">Log 
        Msg </font></strong></td>
    </tr>
	<? do { ?>
    <tr   > 

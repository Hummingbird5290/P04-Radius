...
<table width=\"100%\" border=\"0\">
 ...
 //   print '<center><a href=http://' . $_GET['uamip'] . ':' . $_GET['uamport'] . '/logoff>Logout</a></center>';
		...
		if ($_GET['res'] != popup2 and $_GET['res'] ==success ) { 
		  $s_name = $_GET['uid'];
	     ?><br /><br />
         <center><a href="http://www.google.co.th" onClick="newwindow=window.open('http://radius.thaigqsoft.com/ddwrt_login.php?res=popup2&uamip=192.168.182.1&uamport=3990&uid=<?php print $s_name;?>','popup2','height=320,width=450,left=10,top=100,scrollbars=1');newwindow.focus();"><h3>โปรดคลิกเพื่อเริ่มเล่นอินเตอร์เน็ต<br>ภายในเวลา 15 วินาที</h3></a></center>
		 <?
		    echo "<meta http-equiv=refresh content=15;URL=http://192.168.182.1:3990/logoff>"; 
            exit();
			  }
			    print_footer();
}
...
function print_body() {
    ...
    <body   onBlur = \"javascript:doOnBlur($result)\" bgColor = '#c0d8f4'>

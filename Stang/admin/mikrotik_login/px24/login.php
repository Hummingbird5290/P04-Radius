...
<IFRAME name=main   src=http://www.thaigqsoft.info/show_new.php?domain_name=px24  width=580 height=420 frameborder=0 scrolling=yes></IFRAME>
	...
	<tr>
		...
		<td colspan="4">
			<a href="http://www.thaigqsoft.info/register1.php?domain_name=px24" target="_blank">
	...
	<tr>
		...
		<td colspan="4">
		<a href="http://www.thaigqsoft.info/active.php?domain=px24" target="_blank">
	...
	<tr>
		...
		<td colspan="5">
		<a href="http://www.thaigqsoft.info/card_true_acctive.php?domain_name=px24" target="_blank">
	...
	<tr>
		...
		<td colspan="3">
		<a href="http://www.thaigqsoft.info/problem.php?domain_name=px24" target="_blank">
	...
	<tr>
		...
		<td colspan="3">
			<a href="http://www.thaigqsoft.info/forget_pass.php?domain_name=px24" target="_blank">
...
<a style="color: #0000FF;background-color: #FFFFFF" href="$(link-login-only)?dst=$(link-orig-esc)&username=T-$(mac-esc)">คลิกที่นี่เพื่อทดลองเล่น  15  นาที</a>$(endif)
					...
					<!--			<tr>
								  <td colspan="2" align="right"> <div align="center"><span class="style1">ทดลองเล่นฟรี ,</span>
								      <a  href="<?php echo $linkloginonly; ?>?dst=<?php echo $linkorigesc; ?>&username=T-<?php echo $macesc; ?>">คลิกที่นี่</a></div></td>
							  </tr>-->

...
?>
  <table width="850" border="0" align="center" cellpadding="1" cellspacing="1"  class="imagetable">
    <tr bgcolor="#FFFFFF"> 
      <th height="30" colspan="7"> <div align="right"><strong>ค้นหารหัสบัตร</strong> 
          <input name="txt_search" type="text" value="<?=$txt_search;?>" size="40">
          <input type="submit" name="Submit" value="  ค้นหา  " class="styled-button-2"  >
        </div></th>
    </tr>
    <tr bgcolor="#CCFFCC"> 
      <th colspan="7"> <div align="center" class="style1 style2"><font size="3" face="MS Sans Serif, Tahoma, sans-serif"><strong>รายการบัตรที่ยังไม่มีการใช้งาน</strong></font></div></th>
    </tr>
    <tr bgcolor="#FFFFCC"> 
      ...
      <th width="18%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">อยู่ในกลุ่ม</font></strong></th>
      <th width="19%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วันที่สร้าง</font></strong></th>
      <th width="14%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วันหมดอายุ</font></strong></th>
      <th width="11%" align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">จำนวน</font></strong></th>
      <th width="12%" align="center"><div align="center"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ลบ</font></strong></div></th>
    </tr>
    <?
  if($rows<>0){
	  $i=1;

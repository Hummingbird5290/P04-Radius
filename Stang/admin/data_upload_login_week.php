...
BETWEEN  ' $year_gp-$mountgp-$aa 00:00:00'
AND  '$year_gp-$mountgp-$b 00:00:00'
  ";
$Recordset1 = mysql_query($query_Recordset1, $connect_db) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
$g = new graph();
$g->title( "Online Bar Chart  of  Week $year_gp-$mountgp ", '{font-size:20px; color: #FFFFFF; margin: 10px; background-color: #505050; padding:10px; padding-left: 25px; padding-right: 25px;}' );
$g->data_sets[] = $bar_red;
$g->set_x_axis_3d( 30 );
...
$g->y_axis_colour( '#909090', '#ADB5C7' );
 ...
 $g->set_x_labels( array( $UserNamebar[1],$UserNamebar[2] ,$UserNamebar[3] ,$UserNamebar[4],$UserNamebar[5],$UserNamebar[6]
 )  ); 

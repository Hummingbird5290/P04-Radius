...
<body>
<form action="report_ip_access_web.php" method="post" name="form1" target="_blank">
  <table width="100%" border="1">
    <tr bgcolor="#66CCFF"> 
      <td colspan="2"><div align="center"><strong>รายงานการเข้าเว็บแบบเจาะจงหมายเลขIP</strong></div></td>
    </tr>
    <tr> 
      <td width="25%" bgcolor="#FFFF99"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>หมายเลข 
        IP</strong></font></td>
    ...
    <tr> 
      ...
      <td bgcolor="#CCFFCC"> <input type="submit" name="Submit" value="Submit"> </td>
    </tr>
  </table>
</form>
</body>
